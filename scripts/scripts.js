$(document).ready(function() {
    $('img').hover(function(){
        ...
        if ($(this).attr('src') == 'img/BlackAndWhite/Icon-Logo-BandW.png') {
            $('body').css('background-color', 'rgba(254,253,251,0)');
            $('.container').css('background-color', 'rgba(254,253,251,0)');
            $(this).css('background-color', 'rgba(254,253,251,0)');    
        } else {
            $('body').css('background-color', colours[$arrayindex]);
            $('.container').css('background-color', colours[$arrayindex]);
            $(this).css('background-color', colours[$arrayindex]);
        }
    }); //end of img.hover
